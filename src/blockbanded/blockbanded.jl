...
BroadcastStyle(::Type{<:BlockArray{T,N,<:AbstractArray{T,N},NTuple{N,BlockedUnitRange{OneToInf{Int}}}}}) where {T,N} = LazyArrayStyle{N}()
...
BroadcastStyle(::Type{<:BlockArray{T,N,<:AbstractArray{T,N},<:NTuple{N,BlockedUnitRange{<:RangeCumsum{Int,<:InfRanges}}}}}) where {T,N} = LazyArrayStyle{N}()
